# exercícios de programação em Python com dados da Pesquisa Distrital por Amostra de Domicílios Ampliada (PDADA) 2024

## análise exploratória
- dados disponíveis em https://pdad.ipe.df.gov.br

vamos trabalhar com os arquivos:
...
A coluna `peso_mor` (moradores) e `peso_dom` (domicílios) contém o **peso amostral** de cada registro.

cada entrevistado "representa" um certo número de pessoas reais no DF.

significa que aquele morador representa aproximadamente 79 pessoas na população real do DF.
